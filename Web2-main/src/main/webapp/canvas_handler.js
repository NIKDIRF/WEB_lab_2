function drawCanvas() {
    ...
    context.fillRect(canvas.width / 2, canvas.height * 0.1, canvas.width * 0.4, canvas.height * 0.4); // квадрат
    context.beginPath();
    context.moveTo(canvas.width / 2, canvas.height / 2);
    context.lineTo(canvas.width / 2, canvas.height - canvas.height * 0.1);
    context.lineTo(canvas.width / 2 - canvas.width * 0.2, canvas.height / 2);
    context.fill();
    context.moveTo(canvas.width / 2, canvas.height / 2);
    context.arc(canvas.width / 2, canvas.height / 2, canvas.height / 5, Math.PI, Math.PI * 3 / 2, false);
    context.fill();
